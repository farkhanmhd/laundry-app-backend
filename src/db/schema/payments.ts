...
import { integer, json, pgEnum, pgTable, timestamp, varchar } from "drizzle-orm/pg-core";
...
export const payments = pgTable("payments", {
  ...
  transactionTime: timestamp("transaction_time", { mode: "string" }).defaultNow().notNull(),
  ...
  actions: json("actions").$type<{ name: string; method: string; url: string }[]>(),
